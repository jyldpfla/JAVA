...
public class QuestionPage {
	...
	public QuestionPage(int topic_id, String topic, int question_id, int total, int currentPage, int size, List<Question> question_context) {
		this.topic_id = topic_id;
		this.topic = topic;
		this.quesiton_id = question_id;
		this.total = total;
